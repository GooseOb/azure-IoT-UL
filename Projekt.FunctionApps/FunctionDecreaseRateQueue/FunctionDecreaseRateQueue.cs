...
namespace Projekt.FunctionApps.FunctionDecreaseRateQueue
{
    public static class FunctionDecreaseRateQueue
    {
        [FunctionName("FunctionDecreaseRateQueue")]
        public static async Task Run([ServiceBusTrigger("device-decrease-rate", Connection = "ServiceBusConnectionString")] ServiceBusReceivedMessage message, ServiceBusMessageActions messageActions, ILogger log, ExecutionContext context)
        {
