...
namespace Projekt.FunctionApps.FunctionErrorQueue
{
    public static class FunctionErrorQueue
    {

        [FunctionName("FunctionErrorQueue")]
        public static async Task Run([ServiceBusTrigger("device-emergency-stop", Connection = "ServiceBusConnectionString")] ServiceBusReceivedMessage message, ServiceBusMessageActions messageActions, ILogger log, ExecutionContext context)
        {
